"""Create a draft golden annotation for one mixed-prose OCR sample."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Create a draft mixed-prose OCR golden "
            "annotation."
        )
    )
...
def load_json(path: Path) -> dict[str, Any]:
    """Load and validate the top-level JSON object."""
...
def main() -> int:
    """Draft, validate, and save one mixed-prose sample."""
    ...
    try:
        ...
        current_status = annotations.get(
            "status"
        )
