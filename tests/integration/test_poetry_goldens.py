"""Regression tests for production poetry parsing against goldens."""
...
POETRY_GOLDENS = (
    "pilot_baba_afzal_01.json",
    "pilot_rumi_diwan_01.json",
    "pilot_mathnawi_01.json",
)
...
def load_golden(
    ...
    """Load one completed parser golden."""
...
def record_signature(
    ...
    """Select fields that define one structural block."""
...
def test_production_parser_passes_lossless_gate(
    ...
    """Every reviewed poetry sample must remain lossless."""
